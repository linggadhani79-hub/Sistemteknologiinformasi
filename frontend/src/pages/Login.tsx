      ...
      <div className="grid w-full max-w-4xl overflow-hidden rounded-2xl bg-white shadow-2xl md:grid-cols-2">
        <div className="hidden flex-col justify-center bg-brand-600 p-10 text-white md:flex">
          ...
          <p className="mt-2 text-sm text-brand-50">
            Sistem Informasi Akademik terintegrasi: Neofeeder/PDDikti, PJJ, SPMI, LMS, PMB, Kepegawaian, dan LPPM dalam satu platform.
          </p>
          <ul className="mt-6 space-y-1 text-sm text-brand-50">
            <li>✓ Manajemen akademik & KRS/KHS</li>
            <li>✓ Pelaporan Neofeeder PDDikti</li>
            <li>✓ Pembelajaran daring (LMS + PJJ)</li>
            <li>✓ Penjaminan mutu & LPPM</li>
          </ul>
        </div>
        <div className="p-8">
            ...
            <div className="mt-6 border-t pt-4">
              ...
              <div className="grid grid-cols-2 gap-1">
                {demoAkun.map(([em, label]) => (
                  <button key={em} onClick={() => setEmail(em)} className="rounded px-2 py-1 text-left text-xs text-gray-600 hover:bg-gray-100">
